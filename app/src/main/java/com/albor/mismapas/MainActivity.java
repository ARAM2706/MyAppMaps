...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mapController.setCenter(new GeoPoint(20.1401589, -101.1557202));
        ...
        EditText destinationText = findViewById(R.id.lblDestino);
        ...
        Button searchDestButton = (Button) findViewById(R.id.btnindicaciones);
        searchDestButton.setOnClickListener(view -> searchPlace(DEST_INDEX, R.id.lblDestino));
